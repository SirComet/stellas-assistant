...
/** Blog posts list page with search, status filter, and delete confirmation. */
export default function BlogPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["content-posts", "blog", search, statusFilter],
    queryFn: () =>
      content.posts.list({
        type: "blog",
  ...
  return (
    <AppShell>
      <Header
        title="Blog Posts"
        subtitle={`${data?.total ?? posts.length} posts`}
        actions={
          <Link
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                Write your first blog post to start building your audience
              </p>
              <Link
                href="/content/blog/new"
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-medium text-muted-foreground">Author</th>
                ...
                <tbody>
                  {posts.map((post: ContentPost, i: number) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-xs text-muted-foreground">{post.author}</td>
